...
For the extra, you can either create spans with HTML, then get by ID and append. Alternatively, you can create with React then add as children to the `createElement`
